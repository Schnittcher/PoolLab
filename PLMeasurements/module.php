...
require_once __DIR__ . '/../libs/vendor/SymconModulHelper/VariableProfileHelper.php';
    ...
    class PLMeasurements extends IPSModule
    {
        ...
        public static $Variables = [
            ...
            ['PL_Total_Chlorine', 'Chlorine Total', VARIABLETYPE_FLOAT, 'PoolLab.mgl', false, true],
            ['PL_Total_Chlorine_State', 'Chlorine Total State', VARIABLETYPE_STRING, 'PoolLab.State', false, true],
            ['PL_Total_Chlorine_IdealLow', 'Chlorine Total ideal low', VARIABLETYPE_FLOAT, 'PoolLab.mgl', false, true],
            ['PL_Total_Chlorine_IdealHigh', 'Chlorine Total ideal high', VARIABLETYPE_FLOAT, 'PoolLab.mgl', false, true],
            ['PL_Total_Chlorine_Comment', 'Chlorine Total Comment', VARIABLETYPE_STRING, '', false, true],
            ['PL_Total_Chlorine_Timestamp', 'Chlorine Total last measurement', VARIABLETYPE_INTEGER, '~UnixTimestamp', false, true],
