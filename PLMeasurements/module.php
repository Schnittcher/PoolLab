...
require_once __DIR__ . '/../libs/vendor/SymconModulHelper/VariableProfileHelper.php';
    ...
    class PLMeasurements extends IPSModule
    {
        ...
        public static $Variables = [
            ...
            ['PL_Alkalinity', 'Alkalinity', VARIABLETYPE_FLOAT, '', false, true],
            ['PL_Alkalinity_State', 'Alkalinity State', VARIABLETYPE_STRING, 'PoolLab.State', false, true],
            ['PL_Alkalinity_IdealLow', 'Alkalinity ideal low', VARIABLETYPE_FLOAT, '', false, true],
            ['PL_Alkalinity_IdealHigh', 'Alkalinity ideal high', VARIABLETYPE_FLOAT, '', false, true],
            ['PL_Alkalinity_Comment', 'Alkalinity Comment', VARIABLETYPE_STRING, '', false, true],
            ['PL_Alkalinity_Timestamp', 'Alkalinity last measurement', VARIABLETYPE_INTEGER, '~UnixTimestamp', false, true],
